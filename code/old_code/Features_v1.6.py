...
class FeatureGenerator():
    ...
    @staticmethod
    def add_unique_count_of_feature_under_given_feature_combination(df:pd.DataFrame, features_iterable, objective_features:list, output_dir:str):
        feature_list = []
...
if __name__ == "__main__":
    ...
    t0 = datetime.now()
    df = FeatureGenerator.add_click_count_under_given_feature_combination_within_time_range(df, 'click_time',  combined_feature, dt_range=[0, 3600*1]) # dt_range in second.
    t1 = datetime.now()

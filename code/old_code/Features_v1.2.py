        ...
        if not dt_range: # dt_range is not specified. Calculate the total click count.
            ...
            for groupby_features in features_iterable:
                ...
                for name, group in groups: # group should be a Series.
                    result_temp = check_time_distance_parallel_jit(group.values.astype('datetime64[s]').view('int64'), num_cpus=num_cpus,  split_threshold=10000, dt_backward=dt_backward_seconds_int, dt_forward=dt_forward_seconds_int)
